...
Print "Extract Shipping Code" "rm -rf /home/roboshop/shipping && unzip -O /tmp/shipping.zip && mv shipping-main shipping && cd shipping"
rm -rf /home/roboshop/shipping && unzip  -O /tmp/shipping.zip && mv shipping-main shipping && cd shipping
Stat $?
