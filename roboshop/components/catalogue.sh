...
Print  "Extract Catalogue Component Code" "rm -rf /home/roboshop/catalogue && mkdir -p /home/roboshop/catalogue && cd /home/roboshop && unzip /tmp/catalogue.zip && mv catalogue-main/* . && mv catalogue/* . && rm -rf catalogue-main README.md && mv catalogue/* . && cd /home/roboshop/catalogue"
