...
Print  "Extract User Component Code" "rm -rf /home/roboshop/user && cd /home/roboshop && unzip /tmp/user.zip && mv /home/roboshop/user-main user && cd /home/roboshop/user"
rm -rf /home/roboshop/user && cd /home/roboshop && unzip /tmp/user.zip && mv /home/roboshop/user-main user && cd /home/roboshop/user
Stat $?
