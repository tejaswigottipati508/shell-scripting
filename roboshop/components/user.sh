...
Print "Update SystemD Script for User" "sed -i -e 's/MONGO_ENDPOINT/mongodb-ss.tejadevops.tk/' /home/roboshop/user/systemd.service && mv /home/roboshop/user/systemd.service /etc/systemd/system/user.service"
