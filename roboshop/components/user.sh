...
Print  "Extract user Component Code" "cd /home/roboshop && unzip /tmp/user.zip &&  mv user-main/* . && mv user/* . && cd user"
cd /home/roboshop && unzip /tmp/user.zip &&  mv user-main/* . && mv user/* . && cd user
Stat $?
